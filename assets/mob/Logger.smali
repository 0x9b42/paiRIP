...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmob/Logger;->TIME_FORMAT1:Ljava/text/SimpleDateFormat;
    ...
    sput-object v0, Lmob/Logger;->TIME_FORMAT2:Ljava/text/SimpleDateFormat;

    new-instance v0, Ljava/util/concurrent/LinkedBlockingQueue;

    invoke-direct {v0}, Ljava/util/concurrent/LinkedBlockingQueue;-><init>()V

    sput-object v0, Lmob/Logger;->QUEUE:Ljava/util/concurrent/LinkedBlockingQueue;

    new-instance v0, Ljava/lang/ThreadLocal;

    invoke-direct {v0}, Ljava/lang/ThreadLocal;-><init>()V

    sput-object v0, Lmob/Logger;->PARAMETER_BUFFER:Ljava/lang/ThreadLocal;
...
.method public static logstring(Ljava/lang/Object;)V
    ...
    invoke-static {v0}, Lmob/Logger;->EscapeStrings(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-static {v0}, Lmob/Logger;->z(Ljava/lang/String;)V
...
.method private static z(Ljava/lang/String;)V
    ...
    sget-object v2, Lmob/Logger;->TIME_FORMAT1:Ljava/text/SimpleDateFormat;
    ...
    sget-object v4, Lmob/Logger;->QUEUE:Ljava/util/concurrent/LinkedBlockingQueue;
...
.method public run()V
    ...
    const-string v3, "MOBPKG"

    invoke-virtual {v1, v2, v3}, Ljava/lang/String;->replace(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Ljava/lang/String;

    move-result-object v1

    sget-object v2, Lmob/Logger;->TIME_FORMAT2:Ljava/text/SimpleDateFormat;
    ...
    const-string v4, "/data/data/MOBPKG/dictionary"
    ...
    sget-object v6, Lmob/Logger;->TIME_FORMAT2:Ljava/text/SimpleDateFormat;
